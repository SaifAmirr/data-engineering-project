...
# Define the DAG
with DAG(
    dag_id='order_reviews_postgres_to_bigquery_via_gcs_saif_amir',
    ...
    transfer_to_gcs = PostgresToGCSOperator(
        ...
        sql="SELECT review_id, order_id, review_score FROM order_reviews  ;",  # Your SQL query
        bucket='ready-d25-postgres-to-gcs',  # Your GCS bucket name
        filename='seif/order_reviews/order_reviews.csv',  # GCS object path
    ...
    load_to_bigquery = GCSToBigQueryOperator(
        ...
        bucket='ready-d25-postgres-to-gcs',  # Your GCS bucket name
        source_objects=['seif/order_reviews/order_reviews.csv'],  # GCS object path
        destination_project_dataset_table='ready-de-25.playground.order_reviews_saif',  # BigQuery table
