...
# Define the DAG
with DAG(
    dag_id='orders_postgres_to_bigquery_via_gcs_saif_amir',
    ...
    transfer_to_gcs = PostgresToGCSOperator(
        ...
        filename='seif/orders/orders.csv',  # GCS object path
    ...
    load_to_bigquery = GCSToBigQueryOperator(
        ...
        bucket='ready-d25-postgres-to-gcs',  # Your GCS bucket name
        source_objects=['seif/orders/orders.csv'],  # GCS object path
        destination_project_dataset_table='ready-de-25.playground.orders_saif',  # BigQuery table
